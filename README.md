...
- **Paper**: [PDF](figures/paper.pdf) | [OpenReview](https://openreview.net/forum?id=wfc55x2gK2)
...
@inproceedings{truecity2025,
  ...
  author={Nguyen, Ti and others},
  booktitle={International Conference on 3D Vision (3DCV)},
  year={2025},
  url={https://openreview.net/forum?id=wfc55x2gK2}
}
```
